        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <p className="text-muted-foreground mx-auto mb-10 max-w-xl px-4 text-base leading-relaxed sm:text-lg md:text-xl">
              is a 21st Century Logistics Companies leading "United States of
              America" provider of transportation, warehousing, fulfillment,
              global logistics, business intelligence, technology, and supply
              chain solutions.
            </p>
          </motion.div>
